...
export function XIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <path d="M13.6 10.6 20.24 3h-1.57l-5.76 6.6L8.32 3H3l6.96 9.98L3 21h1.57l6.08-6.97 4.86 6.97H21l-7.4-10.4zm-2.15 2.47-.7-1L5.15 4.2h2.4l4.5 6.44.7 1 5.86 8.38h-2.4l-4.76-6.95z" />
    </svg>
  );
}
